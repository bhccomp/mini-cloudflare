    ...
    <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div class="order-2 lg:order-2">
                <h2 class="text-3xl font-semibold text-white">How FirePhage Protects Your Infrastructure</h2>
                <p class="mt-4 text-sm leading-7 text-slate-300">
                    Every request passes through the FirePhage edge network where automated filtering and WAF rules analyze traffic patterns, block malicious behavior, and forward only legitimate requests to your origin infrastructure.
                </p>
