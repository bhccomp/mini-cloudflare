    ...
    <head>
        ...
        <style>
            .theme-v3 {
                ...
                --fp-card: #21252E;
                --fp-accent: #F59E0B;
                --fp-accent-hover: #FBBF24;
                --fp-text: #E6EAF0;
                --fp-border: rgba(255, 255, 255, 0.05);
                --fp-glow: rgba(245, 158, 11, 0.25);
                --fp-btn-text: #0F1115;
                background: var(--fp-bg);
                color: var(--fp-text);
            }

            .theme-v3 .relative.isolate.overflow-hidden > .pointer-events-none.absolute.inset-0.-z-10 {
                background: radial-gradient(circle at 22% 20%, rgba(245, 158, 11, 0.16), transparent 38%), radial-gradient(circle at 80% 0%, rgba(251, 191, 36, 0.1), transparent 34%), linear-gradient(to bottom, #0F1115, #0F1115) !important;
            }

            .theme-v3 main > section {
                background: var(--fp-bg) !important;
                border-color: var(--fp-border) !important;
            }

            .theme-v3 main > section:nth-of-type(even) {
                background: var(--fp-bg-2) !important;
            }

            .theme-v3 main > section:first-of-type > .pointer-events-none.absolute.inset-0.z-0 > .absolute.inset-0 {
                background: radial-gradient(circle at 73% 30%, rgba(245, 158, 11, 0.22), transparent 44%), linear-gradient(90deg, rgba(15, 17, 21, 0.96) 0%, rgba(15, 17, 21, 0.88) 36%, rgba(15, 17, 21, 0.48) 66%, rgba(15, 17, 21, 0.16) 100%) !important;
            }

            .theme-v3 [class*="text-white"] { color: var(--fp-text) !important; }
            .theme-v3 [class*="text-slate-"] { color: rgba(230, 234, 240, 0.78) !important; }
            .theme-v3 [class*="text-cyan-"] { color: var(--fp-accent-hover) !important; }
            .theme-v3 [class*="border-cyan-"] { border-color: var(--fp-accent) !important; }
            .theme-v3 [class*="bg-cyan-"][class*="/"] { background-color: rgba(245, 158, 11, 0.12) !important; }

            .theme-v3 main section article,
            .theme-v3 main section .rounded-2xl.border {
                background: var(--fp-card) !important;
                border-color: var(--fp-border) !important;
            }

            .theme-v3 main section article:hover,
            .theme-v3 main section .rounded-2xl.border:hover {
                border-color: var(--fp-accent) !important;
                box-shadow: 0 0 18px var(--fp-glow) !important;
            }

            .theme-v3 a[class*="bg-cyan-"] {
                background: var(--fp-accent) !important;
                color: var(--fp-btn-text) !important;
                border-color: transparent !important;
            }

            .theme-v3 a[class*="bg-cyan-"]:hover {
                background: var(--fp-accent-hover) !important;
                box-shadow: 0 0 16px var(--fp-glow) !important;
                color: var(--fp-btn-text) !important;
            }

            .theme-v3 a[class*="border-slate-"],
            .theme-v3 a[class*="border-cyan-"][class*="bg-transparent"],
            .theme-v3 a[href="#dashboard-preview"] {
                border-color: var(--fp-accent) !important;
                color: var(--fp-accent-hover) !important;
                background: transparent !important;
            }

            .theme-v3 a[href="#dashboard-preview"]:hover {
                box-shadow: 0 0 16px var(--fp-glow) !important;
                background: rgba(245, 158, 11, 0.1) !important;
            }

            .theme-v3 a:not([class*="bg-cyan-"]):hover {
                color: var(--fp-accent-hover) !important;
            }
        </style>
    </head>
    <body class="theme-v3 bg-slate-950 text-slate-100 antialiased">
