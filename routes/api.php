...
use App\Http\Controllers\Api\PluginFirewallRuleDeleteController;
use App\Http\Controllers\Api\PluginFirewallRuleToggleController;
...
Route::post('/plugin/firewall-rule/delete', PluginFirewallRuleDeleteController::class);
Route::post('/plugin/firewall-rule/toggle', PluginFirewallRuleToggleController::class);
